<x-admin-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <form method="POST" action="{{ route('admin.company-users.store') }}">
                @csrf
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-md p-4 mb-6">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-blue-800">Company User Information</h3>
                            <div class="mt-2 text-sm text-blue-700">
                                <ul class="list-disc pl-5 space-y-1">
                                    <li>This user will be assigned the "company_user" role automatically</li>
                                    <li>Company users can manage their own agents and properties</li>
                                    <li>They can view properties created by themselves and their agents</li>
                                    <li>They cannot see data from other company users</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-end">
                    <a href="{{ route('admin.company-users.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded mr-3">
                        Cancel
                    </a>
