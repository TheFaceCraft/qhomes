    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Company Users Management') }}
            </h2>
            <a href="{{ route('admin.company-users.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $companyUsers->total() }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ \App\Models\User::where('role', 'company_user')->where('status', 'inactive')->count() }}</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-500">{{ $user->role_display }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('admin.company-users.show', $user) }}" class="text-blue-600 hover:text-blue-900">View</a>
                                        
                                        @if($user->status === 'active')
                                            <form method="POST" action="{{ route('admin.company-users.deactivate', $user) }}" class="inline">
                                                @csrf
                                        ...
                                        @else
                                            <form method="POST" action="{{ route('admin.company-users.activate', $user) }}" class="inline">
                                                @csrf
